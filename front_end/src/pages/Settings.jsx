      ...
      <main className="settings-wrap">
        ...
        <section className="settings-card">
          ...
          <div className="settings-row">
            ...
            <div className="settings-row-actions">
              <button className="btn" type="button" onClick={onPickAvatar} disabled={busy}>
                <Upload size={16} />
                Change
              </button>
        ...
        <section className="settings-card">
          ...
          <div className="settings-row">
            ...
            <div className="settings-row-actions">
              <button className={isPrivate ? 'toggle on' : 'toggle'} type="button" onClick={onTogglePrivacy} disabled={busy || loading}>
                <span className="dot" />
              </button>
            </div>
          </div>
        ...
        <section className="settings-card">
          ...
          <div className="settings-row">
            ...
            <div className="settings-row-actions">
              ...
              <button className="btn" type="button" onClick={onSaveUnits}>Save</button>
            </div>
          </div>
        </section>
        ...
        <section className="settings-card danger">
          ...
          <div className="settings-row">
            ...
            <div className="settings-row-actions">
              <button className="btn danger" type="button" onClick={onLogout}>Logout</button>
            </div>
          </div>

          <div className="settings-row" style={{ borderTop: '1px solid rgba(11, 18, 32, 0.10)' }}>
            <div className="settings-row-main">
            ...
            <div className="settings-row-actions">
              <button className="btn danger" type="button" onClick={onDeleteAccount} disabled={busy || loading}>
